<?php /* Smarty version Smarty-3.1.12, created on 2012-11-13 10:37:01
...
'>			<div class='goal-title'><?php echo $_smarty_tpl->tpl_vars['goal']->value['Title'];?>
</div>			<div class='goal-why'><?php echo $_smarty_tpl->tpl_vars['goal']->value['Reason'];?>
</div>			<div class='goal-info-wap'><b><?php echo $_smarty_tpl->tpl_vars['goal']->value['logsNum'];?>
</b> 记录</div>		</a>			<!-- 命令按钮 -->		<div class='goal-cmd-wap'>			<a class='btn btn-small goal-cmd'				href="GoalC.php?act=edit&goalID=<?php echo $_smarty_tpl->tpl_vars['goal']->value['GoalID'];?>
