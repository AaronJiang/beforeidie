<?php /* Smarty version Smarty-3.1.12, created on 2012-10-21 05:38:38
...
<?php if ($_valid && !is_callable('content_5083562686a9a3_31675913')) {function content_5083562686a9a3_31675913($_smarty_tpl) {?><!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'><html xmlns='http://www.w3.org/1999/xhtml'>	<head>		<meta http-equiv='Content-Type' content='text/html; charset=utf-8' />		<title><?php echo $_smarty_tpl->tpl_vars['title']->value;?>
...
'>																	<div id='feedback-panel'>			<div id='feedback-tag'></div>				<form action='feedback_proc.php'method='post' id='form-feedback'>					<input id='feedback-subject' name='feedbackSubject' placeholder='主题（可不填）' autocomplete='off' type='text' />					<textarea id='feedback-content' class='validate[required]' name='feedbackContent' rows='10' placeholder='建议内容'></textarea>					<input id='submit-feedback' type='submit' value='发送'>				</form>			</div>								<div id='header'>				<div id='header-wap'>					<a id='logo-link' href='home.php'></a>								<ul id='nav' class='clearfix'>						<li><a id='nav-goals' href='../controller/HomeController.php?action=home'>我的Goals</a></li>						<li><a id='nav-dynamic' href='../controller/DynamicController.php?action=followees'>动态</a></li>						<li><a id='nav-person' href='../controller/PersonController.php'>个人主页</a></li>						<li><a id='nav-newgoal' href='../controller/GoalController.php?action=new'>新建</a></li>						<li><a id='nav-discover' href='../controller/GoalController.php?action=discover'>发现</a></li>					</ul>									<div id='account-info'>						<span><a href='../controller/AccountController.php?action=details'>hustlzp的账号</a></span>						<span><a href='../controller/AccountController.php?action=logout'>退出</a></span>					</div>				</div>			</div>			<div id='content-wap' class='clearfix'><?php }} ?>