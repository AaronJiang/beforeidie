<?php
	...
	function get_dynamics($userID){
		//获取 Goal 的创建动态
		$query = "(SELECT 'newGoal' as type, users.Username as Poster, goals.UserID as PoserID, GoalID, Title as GoalTitle, Reason as GoalReason, NULL as LogTitle, NULL as LogContent, CreateTime as Time\n"
				. "FROM goals, users\n"
