<div id='form-wap'>
	...
	<?= form_open('account/register', array('id'=>'form-register')) ?>
		...
		<input type='text' title='你的称呼，亲！' placeholder='用户名' autocomplete='off' name='username' id="input-username" value="<?= set_value('username') ?>" />

		<input type='password' title='设置密码，6-16位之间，建议数字和字母混合。' id='pwd' placeholder='密码' autocomplete='off' name='password' value="<?= set_value('password') ?>" />
